class Admin::UsersController < ApplicationController
  ...
  before_action :set_user, only: [:approve, :reject, :destroy, :update_teacher]
  ...
  def approve
    ...
    redirect_to admin_users_path, notice: "#{@user.name}님의 가입이 승인되었습니다."
  end
  
  def reject
    @user.destroy
    redirect_to admin_users_path, notice: "가입 요청이 거부되었습니다."
  end
